...
from data.models.prepaid_card_operations import (
    PREPAID_CARD_COUNTS_CURATED_TABLE,
    PREPAID_CARD_COUNTS_RAW_TABLE,
    PREPAID_CARD_OPS_CURATED_TABLE,
    PREPAID_CARD_OPS_RAW_TABLE,
...
def upsert_prepaid_card_ops_raw(sb, observations: list[PrepaidCardOpsRawObservation]):
    if not observations:
        return None
    return (
