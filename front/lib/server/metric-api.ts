...
const DATASET_CONFIG: Record<Exclude<DatasetName, "uf-latest">, DatasetConfig> = {
  "credit-card-ops": {
    ...
    publicSelect:
      "operation_type,dataset_code,institution_code,institution_name,period_month,transaction_count,nominal_volume_millions_clp,source_dataset_code,updated_at",
    protectedSelect:
  ...
  "prepaid-card-ops": {
    ...
    publicSelect:
      "customer_type,operation_type,dataset_code,institution_code,institution_name,period_month,transaction_count,nominal_volume_millions_clp,source_dataset_code,updated_at",
    protectedSelect:
  ...
  "checking-accounts": {
    ...
    publicSelect:
      "account_type,dataset_code,institution_code,institution_name,period_month,account_count,nominal_balance_millions_clp,source_dataset_code,updated_at",
    protectedSelect:
